...
//!         leaving the ship at east 100, north 10. The waypoint stays 10 units east and 1 unit
//!         north of the ship.
...
// console
fn time_it(f: fn(&str) -> (), filename: &str) {
...
fn main() {
    ...
    time_it(part_one::solve, filename); // 1032
    time_it(part_two::solve, filename); // 156735
}
