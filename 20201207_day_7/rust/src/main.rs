...
// console
fn time_it(
    f: fn(&str, &HashMap<String, HashMap<String, u32>>) -> (), 
    name: &str, 
...
fn main() {
    ...
    // Run the parts and report the results and timing
    time_it(part_one::solve, "shiny gold bag", &input); // 296
    time_it(part_two::solve, "shiny gold bag", &input); // 9339
}
